        ...
        <section class="section-default">
          ...
          if (isset($_GET["error"])) {
            if ($_GET["error"] == "emptyfields") {
              echo '<p class="signuperror">Please fill in all fields in order to access the system.</p>';
            }
            else if ($_GET["error"] == "invaliduidmail") {
              echo '<p class="signuperror">The username or email address does not exist.</p>';
            }
            else if ($_GET["error"] == "invaliduid") {
              echo '<p class="signuperror">You have entered an invalid username.</p>';
            }
            else if ($_GET["error"] == "invalidmail") {
              echo '<p class="signuperror">You have entered in an invalid email address.</p>';
            }
            else if ($_GET["error"] == "passwordcheck") {
              echo '<p class="signuperror">The passwords you have entered do not match.</p>';
            }
            else if ($_GET["error"] == "usertaken") {
              echo '<p class="signuperror">The username you have chosen is already taken. Please try something else.</p>';
            }
          }
